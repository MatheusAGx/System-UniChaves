...
<div class="card my-2" style="width: full;">
    ...
    <div class="card-body">
        ...
        <div class="row p-2">
            <div class="col-6">
                <h6>Senha: </h6>
                <input id="senha" onkeyup="validaSenha()" name="senha" type="password" class="form-control" placeholder="Senha (mínimo 8 caracteres)" aria-label="Senha" value=<?= $usuario->senha?>>
                <span class="p-1 validacao" id="msg_senha"></span>
            </div>
            <div class="col-6">
                <h6>Confirme sua senha: </h6>
                <input id="confirma-senha" onkeyup="validaConfirmaSenha()" name="confirma-senha" type="password" class="form-control" placeholder="Confirme sua senha" value=<?= $usuario->senha?>>
        ...
        <div class="row p-2" >
            <div class="col-6">
                <h6>CPF: </h6>
                <input id="cpf" onkeyup="msgCpf()" name="cpf" type="text" class="form-control" placeholder="CPF XXX.XXX.XXX-XX" aria-label="CPF" value="<?=$usuario->cpf ?>">
                <span class="p-1 validacao" id="msg_cpf"></span>
            </div>
                
            <div class="col-6">
                <h6>CNPJ: </h6>
                <input id="cnpj" onkeyup="msgCnpj()" name="cnpj" type="text" class="form-control" placeholder="CNPJ" aria-label="CNPJ" value="<?=$usuario->cnpj?>">
        ...
        <div class="row p-2" >
            <div class="col-6">
                <h6>E-mail: </h6>
                <input id="email" onkeyup="msgEmail()" name="email" type="text" class="form-control" placeholder="E-mail" aria-label="E-mail" value="<?=$usuario->email?>">
                <span class="p-1 validacao" id="msg_email"></span>
            </div>
        
            <div class="col-6">
                <h6>Telefone: </h6>
                <input id="tel1" onkeyup="msgTelefone1()" name="tel" type="text" class="form-control" placeholder="(DDD) + Número" aria-label="(DDD) 9 xxxx-xxxx" value="<?=$usuario->telefone?>">
        ...
        <div class="row p-2">
            ...
            <div class="col-2">
                <h6>CEP: </h6>
                <input id="cep" name="cep" type="text" class="form-control" placeholder="CEP" aria-label="CEP" value="<?=$usuario->cep?>">
                <span class="p-1 validacao" id="msg_cep"></span>
            </div>
            <div class="col-8">
                <h6>Endereço: </h6>
                <input id="endereco" name="endereco" type="text" class="form-control" placeholder="Rua ou Avenida" aria-label="Endereco" value="<?=$usuario->endereco?>">
            </div>
            <div class="col-2">
                <h6>Número: </h6>
                <input id="numero_casa" name="numero_casa" type="text" class="form-control" placeholder="Nº" aria-label="Número da casa" value="<?=$usuario->numero?>">
            </div>
        </div>
        <div class="row p-2">
            <div class="col-4">
                <h6>Bairro: </h6>
                <input id="bairro" name="bairro" type="text" class="form-control" placeholder="Bairro" aria-label="Bairro" value="<?=$usuario->bairro?>">
            </div>
            <div class="col-4">
                <h6>Cidade: </h6>
